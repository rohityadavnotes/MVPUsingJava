...
public class NetworkConnectivityUtil {
    ...
    public static void openWirelessSettings(@NonNull Activity activity) {
        ...
        {
            intent = new Intent(Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    /**
     * Method to Open the network settings
     *
     * @param activity - Activity
     */
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
        {
            if (connectivityManager != null)
            {
                ...
                if(networkCapabilities != null)
                {
                    ...
                    {
                        Log.e("Network", "getNetworkCapabilities(connectivityManager.getActiveNetwork()) : MOBILE");
                        connectedBoolean    = true;
                        connectedInt        = 1;
                    }
                    else if (networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_WIFI))
                    {
                        Log.e("Network", "getNetworkCapabilities(connectivityManager.getActiveNetwork()) : WIFI");
                        connectedBoolean    = true;
                        connectedInt        = 2;
                    }
                }
                ...
                if (networkInfos != null)
                {
                    for (int i = 0; i < networkInfos.length; i++)
                    {
                        if (networkInfos[i].getState() == NetworkInfo.State.CONNECTED)
                        {
                            ...
                            {
                                Log.e("Network", "getAllNetworkInfo() : MOBILE");
                                connectedBoolean    = true;
                                connectedInt        = 1;
                                break;
                            }
                            ...
                            {
                                Log.e("Network", "getAllNetworkInfo() : WIFI");
                                connectedBoolean    = true;
                                connectedInt        = 2;
                                break;
                            }
    ...
    private NetworkConnectivityUtil() {
        throw new UnsupportedOperationException(
                "Should not create instance of NetworkConnectivityUtil class. Please use as static..");
    }
}
