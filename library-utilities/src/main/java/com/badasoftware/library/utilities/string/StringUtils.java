package com.badasoftware.library.utilities.string;

import com.badasoftware.library.utilities.ObjectUtils;
...
public class StringUtils {
    ...
    public static String convertNullStringToEmpty(Object string) {
        return (string == null ? StringConstants.EMPTY_STRING : (string instanceof String ? (String) string : string.toString()));
    }
