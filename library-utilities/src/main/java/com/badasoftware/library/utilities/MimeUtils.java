...
public class MimeUtils {
     ...
     */
    static {
        /* Not in Android's MimeUtils.java as of API 25. */
    ...
    public static String guessMimeTypeFromExtension(String extension) {
        return extension != null && !extension.isEmpty() ? extensionToMimeTypeMap.get(extension) : null;
    }
    ...
    public static String guessExtensionFromMimeType(String mimeType) {
        return mimeType != null && !mimeType.isEmpty() ? mimeTypeToExtensionMap.get(mimeType) : null;
    }
    ...
    /**
     * get file name from url with extension
     *
     *  Input: "null" Output: ""
     *  Input: "" Output: ""
