...
import com.badasoftware.library.network.download.DownloadFile;
import com.badasoftware.library.network.download.DownloadingFileListener;
import com.badasoftware.library.network.download.write.FileWriteHandler;
import com.badasoftware.library.numberprogressbar.two.NumberProgressBar;
import com.badasoftware.library.utilities.AssetsFileUtils;
import com.badasoftware.library.utilities.MimeUtils;
import com.badasoftware.library.utilities.file.FileUtils;
import com.badasoftware.library.utilities.saf.RequestCodeConstants;
import com.badasoftware.library.utilities.saf.SAFUtils;
import com.mvp.using.java.R;
import com.mvp.using.java.model.withbase.DownloadThis;
...
public class DownloadFileActivity extends BaseActivity implements HasAndroidInjector {
    ...
    protected void setOnClickListener() {
        downloadFileButtonTextView.setOnClickListener(this);
    }

    @Override
    protected void handleClickEvent(View view) {
        switch (view.getId()) {
            case R.id. downloadFileButtonTextView:
    ...
    private ArrayList<DownloadThis> getDownloadThisArrayList() {
        try
        {
            JSONObject object = AssetsFileUtils.loadJSONFromAsset(getApplicationContext(),"json/download.json");
