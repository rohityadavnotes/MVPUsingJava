package com.badasoftware.library.network.func;
    ...
    public ObservableSource<?> apply(@NonNull Observable<Throwable> throwableObservable) throws Exception {
        return throwableObservable.flatMap(new Function<Throwable, ObservableSource<?>>() {
            ...
            public ObservableSource<?> apply(@NonNull Throwable throwable) throws Exception {
                ...
                /* If throwable is UnknownHostException, not necessary to retry the request */
                ...
                if (++retryCount <= maxRetries) {
                    ...
                    Log.e(TAG, "Observable get error, it will try after " + retryDelaySeconds + " second, retry count " + retryCount);
