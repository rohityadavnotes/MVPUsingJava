...
import com.badasoftware.library.network.cache.CacheCreator;
import com.badasoftware.library.network.interceptor.ApiKeyInterceptor;
import com.badasoftware.library.network.interceptor.BearerAuthenticationInterceptor;
import com.badasoftware.library.network.interceptor.HeaderInterceptor;
import com.badasoftware.library.network.interceptor.ProvideCacheInterceptor;
import com.badasoftware.library.network.interceptor.ProvideOfflineCacheInterceptor;
...
public class OkHttpClientHelper {
    ...
    public class Builder {
        ...
        public final String TAG = Builder.class.getSimpleName();
        ...
        private Map<String, String> headers                             = new LinkedHashMap<>(); /* Request header */
        ...
        public OkHttpClient build(){
            ...
            if(!CommonUtils.isEmpty(bearerAuthenticationToken))
            {
            ...
            if (enableCache)
            {
                Cache cache = new CacheCreator(context, cacheDirectoryPath, cacheFileName, cacheSize).getCache();
        ...
        public boolean isCustomCacheTime()
        {
            ...
            {
                Log.e(TAG, "Could not set new CacheConfigurationInterceptor(context, cacheDurationWithNetworkInSeconds, cacheDurationWithoutNetworkInSeconds), not provide cacheDurationWithNetworkInSeconds");
                return false;
            }
            else if (cacheDurationWithoutNetworkInSeconds <= 0)
            {
                Log.e(TAG, "Could not set new CacheConfigurationInterceptor(context, cacheDurationWithNetworkInSeconds, cacheDurationWithoutNetworkInSeconds), not provide cacheDurationWithoutNetworkInSeconds");
                return false;
            }
