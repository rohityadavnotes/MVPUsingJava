package com.badasoftware.library.network.rx;
...
public class DisposablePool {
    ...
    public Disposable add(@NonNull Object tagName, Disposable disposable) {
        ...
        if (compositeDisposable == null) {
            ...
            Log.e(TAG,"Call add(@NonNull Object tagName, Disposable disposable)");
        }
    ...
    public void remove(@NonNull Object tagName) {
        ...
        if (compositeDisposable != null) {
            ...
            Log.e(TAG,"Call remove(@NonNull Object tagName)");
        }
    }
